...
export const LOCAL_STORAGE_CONNECTION_COLS_KEY = 'netflow-traffic-connection-columns';
export const LOCAL_STORAGE_CONNECTION_COLS_SIZES_KEY = 'netflow-traffic-connection-column-sizes';
export const LOCAL_STORAGE_FLOW_COLS_KEY = 'netflow-traffic-flow-columns';
export const LOCAL_STORAGE_FLOW_COLS_SIZES_KEY = 'netflow-traffic-flow-column-sizes';
