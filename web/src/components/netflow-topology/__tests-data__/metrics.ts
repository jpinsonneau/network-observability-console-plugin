...
export const dataMock = (responseMock.data.result as Metrics[]).flatMap(r => calculateMatrixTotals(r, 'sum', 300, 60));
...
export const dataSample = (responseSample.data.result as Metrics[]).flatMap(r =>
  calculateMatrixTotals(r, 'sum', 300, 60)
);
