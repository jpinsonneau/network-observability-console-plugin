      ...
      if (prettyPrint) {
        return (
          <Content className="netobserv-tooltip-text">
            <Content component={ContentVariants.p} style={contentStyle}>{`${t('From')} ${fromText}`}</Content>
            <Content component={ContentVariants.p} style={contentStyle}>{`${t('To')} ${toText}`}</Content>
          </Content>
        );
      } else {
