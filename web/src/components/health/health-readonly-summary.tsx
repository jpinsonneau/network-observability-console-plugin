import { Card, CardBody, Flex, FlexItem, Spinner, Text, TextVariants } from '@patternfly/react-core';
    ...
    return (
      <Flex className="health-section-summary health-readonly-summary" {...sectionSummaryLayout}>
        <FlexItem className="health-section-summary-heading">
          ...
          <Text component={TextVariants.p} className="health-summary-section-description">
            {sectionDescription}
          </Text>
        </FlexItem>
